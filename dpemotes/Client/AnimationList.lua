...
-----------------------------------------------------------------------------------------------------------
   ...
   ["smoke"] = {"Scenario", "WORLD_HUMAN_SMOKING", "Smoke", 'cigar'},
   ["smokeweed"] = {"MaleScenario", "WORLD_HUMAN_DRUG_DEALER", "Smoke Weed", 'cigar'},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["box2"] = {"anim@heists@box_carry@", "idle", "Box 2", AnimationOptions =
   {
       ...
       PropBone = 60309,
       PropPlacement = {0.075, -0.1, 0.255, -50.0, 290.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["felezyab"] = {"mini@golfai", "wood_idle_a", "Felez yab", AnimationOptions =
   {
       Prop = "w_am_digiscanner",
       PropBone = 18905,
       PropPlacement = {0.15, 0.1, 0.0, 270.0, 90.0, 80.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},

...
RegisterNetEvent('usehollysion')
AddEventHandler('usehollysion',function()
...
RegisterNetEvent('usehollysion2')
AddEventHandler('usehollysion2',function()
    hollysion = 1
end)
...
Citizen.CreateThread(function()
    ...
    if Config.ShowBlips then
        ...
        --  CreateBlipCircle(vector3(-1172.02, -1571.98, 4.66), 'Drug Dealer', 1.0, 1, 355)
        for k,v in pairs(Config.ProcessZones) do
            CreateBlipCircle(v.coords, v.name, v.radius, v.color, v.sprite)
        end
        CreateBlipCircle(vector3(152.57,-3192.12,4.99), 'Extra Drug', 1.0, 1, 496)
    end
end)
...
RegisterNetEvent('esx_jk_drugs:useItemss')
AddEventHandler('esx_jk_drugs:useItemss', function(itemName)
    ESX.UI.Menu.CloseAll()
    ...
    if itemName == 'marijuana' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:onPotss')
        end)
    ...
    elseif itemName == 'cocaine' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:cokedOutss')
        end)
    ...
    elseif itemName == 'meth' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:icedOutss')
        end)
    ...
    elseif itemName == 'crack' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:crackedOutss')
        end)
    ...
    elseif itemName == 'heroine' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:noddinOutss')
        end)
    ...
    elseif itemName == 'drugtest' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:testingss')
        end)

    elseif itemName == 'fakepee' then

        ESX.ShowNotification(_U('fake_pee'))
        TriggerEvent('esx_jk_drugs:fakePeess')
    ...
    elseif itemName == 'beer' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:buzzinss')
        end)
    ...
    elseif itemName == 'tequila' then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            ...
            TriggerEvent('esx_jk_drugs:drunkss')
        end)
    ...
    elseif itemName == 'breathalyzer' then
        ...
        TriggerEvent('esx_jk_drugs:breathalyzerss')
    end
end)

RegisterNetEvent('esx_jk_drugs:onPotss')
AddEventHandler('esx_jk_drugs:onPotss', function()
...
RegisterNetEvent('esx_jk_drugs:cokedOutss')
AddEventHandler('esx_jk_drugs:cokedOutss', function()
...
RegisterNetEvent('esx_jk_drugs:icedOutss')
AddEventHandler('esx_jk_drugs:icedOutss', function()
...
RegisterNetEvent('esx_jk_drugs:noddinOutss')
AddEventHandler('esx_jk_drugs:noddinOutss', function()
...
RegisterNetEvent('esx_jk_drugs:buzzinss')
AddEventHandler('esx_jk_drugs:buzzinss', function()
...
RegisterNetEvent('esx_jk_drugs:drunkss')
AddEventHandler('esx_jk_drugs:drunkss', function()
...
RegisterNetEvent('esx_jk_drugs:testingss')
AddEventHandler('esx_jk_drugs:testingss', function()
    DoScreenFadeOut(1000)
    Citizen.Wait(1000)
    DoScreenFadeIn(1000)
    if onDrugs then
        ESX.ShowNotification(_U('drug_fail'))
        TriggerServerEvent('esx_jk_drugs:testResultsFailss')
    else
        ESX.ShowNotification(_U('drug_pass'))
        TriggerServerEvent('esx_jk_drugs:testResultsPassss')
    end
end)

RegisterNetEvent('esx_jk_drugs:fakePeess')
AddEventHandler('esx_jk_drugs:fakePeess', function()
...
RegisterNetEvent('esx_jk_drugs:breathalyzerss')
AddEventHandler('esx_jk_drugs:breathalyzerss', function()

    if onBeer then
        ESX.ShowNotification(_U('fail_tipsy'))
        TriggerServerEvent('esx_jk_drugs:testResultsFailTipsyss')
    elseif onLiquor then
        ESX.ShowNotification(_U('fail_drunk'))
        TriggerServerEvent('esx_jk_drugs:testResultsFailDrunkss')
    else
        ESX.ShowNotification(_U('bca_pass'))
        TriggerServerEvent('esx_jk_drugs:testResultsPassBCAss')
    end
end)

RegisterNetEvent('esx_jk_drugs:crackedOutss')
AddEventHandler('esx_jk_drugs:crackedOutss', function()
    RequestAnimSet("move_m@hurry_butch@a")
    while not HasAnimSetLoaded("move_m@hurry_butch@a") do
        Citizen.Wait(0)
    end
...
RegisterNetEvent('esx_jk_drugs:sellingss')
AddEventHandler('esx_jk_drugs:sellingss', function()
    ...
    elseif Config.UseGCPhone then
		...
		TriggerServerEvent('esx_jk_drugs:policeAlertss')
	end
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and ESX.inRealWorld() then
				...
				if CurrentAction == 'cocke_menu' then
					...
					if not canPickUp then ESX.ShowNotification('Shoma nemitavanid in kar ra anjam dahid') return end
                    TriggerEvent("mythic_progbar:client:progress", {
						name = "process_cocaine",
						duration = exports['sunset_utils']:getSkillTime('crack_skill', 'farm_cocaine'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processCocaPlantss')
				...
				elseif CurrentAction == 'crack_menu' then
					...
					TriggerEvent("mythic_progbar:client:progress", {
						name = "process_crack",
						duration = exports['sunset_utils']:getSkillTime('crack_skill', 'farm_crack'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processCokess')
                ...
                elseif CurrentAction == "marijuana_menu" then
                    ...
                    ESX.TriggerServerCallback('esx_jk_drugs:canPickUpss', function(canPickUp)
                        ...
                        TriggerEvent("mythic_progbar:client:progress", {
                            ...
                            duration = exports['sunset_utils']:getSkillTime('marijuana_skill', 'farm_marijuana'),
                            ...
                            if not status then
                                ...
                                ESX.TriggerServerEvent('esx_jk_drugs:processCannabisss')
                ...
                elseif CurrentAction == "ephedrine_menu" then
                    ...
                    TriggerEvent("mythic_progbar:client:progress", {
						...
						duration = exports['sunset_utils']:getSkillTime('meth_skill', 'farm_ephedrine'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processEphedrass')
                ...
                elseif CurrentAction == "poppy_menu" then
                    ...
                    TriggerEvent("mythic_progbar:client:progress", {
						name = "process_opium",
						duration = exports['sunset_utils']:getSkillTime('heroine_skill', 'farm_opium'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processPoppyss')
                ...
                elseif CurrentAction == "opium_menu" then
                    ...
                    TriggerEvent("mythic_progbar:client:progress", {
						name = "process_opium",
						duration = exports['sunset_utils']:getSkillTime('heroine_skill', 'farm_heroine'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processOpiumss')
                ...
                elseif CurrentAction == "meth_menu" then
                    ...
                    TriggerEvent("mythic_progbar:client:progress", {
						name = "process_meth",
						duration = exports['sunset_utils']:getSkillTime('meth_skill', 'farm_meth'),
						...
						if not status then
							...
							ESX.TriggerServerEvent('esx_jk_drugs:processEphedriness')
...
RegisterNetEvent('esx_jk_drugs:getPricess')
AddEventHandler('esx_jk_drugs:getPricess', function(data)
    price = data
end)
local DrugPrices = {}

	DrugPrices["marijuana"] = math.random(300, 335)
	DrugPrices["crack"] = math.random(1650 , 1950)
	DrugPrices["cocaine"] = math.random(2900 , 3400)
	DrugPrices["heroine"] = math.random(5650, 6650)
	DrugPrices["meth"]  = math.random(6250, 7250)
...
--[[function OpenDrugShop()
    ...
    for k, v in pairs(ESX.GetPlayerData().inventory) do
	 print(v.name)
            if DrugPrices[v.name] then
                if d and v.count > 0 then
                    table.insert(elements, {
                        label = ('%s - <span style="color:green;">%s</span>'):format(v.label, _U('dealer_item', ESX.Math.GroupDigits(DrugPrices[v.name]))),
                        name = v.name,
                        price = d,
    ...
    dprice = {}
    dprice.marijuana = math.random(200, 275)
	dprice.crack = math.random(1000 , 1250)
	dprice.cocaine = math.random(1700 , 2000)
	dprice.heroine = math.random(4000, 4500)
	dprice.meth = math.random(5500, 6250)
    dprice.extra_marijuana = math.random(1500, 1850)
    dprice.extra_heroine = math.random(2750, 3100)
    dprice.extra_meth = math.random(3750, 4000)
    dprice.extra_crack = math.random(1500, 1850)
            ...
            function(data1,menu1)
                ...
                if data1.value then
                    ...
                    if count <= data.current.max then
                        ESX.TriggerServerEvent('esx_drugs:sellDrug', data.current.name, count)
                        OpenDrugShop()
                    else
                        ESX.Alert('Error','Shoma in meghdar az in drug ra nadarid',5000,'error')
                    end
                end

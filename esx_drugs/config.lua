...
Config.ProcessZones = {
	...
	MethProcessing = {coords = vector3(1607.53,3573.34,38.78 ), name = 'Laboratory Shishe', color = 25, sprite = 93, radius = 1.0},
	CrackProcessing = {coords = vector3(-2083.58, -1011.96, 5.88), name = 'Laboratory Crack', color = 72, sprite = 226, radius = 1.0},
...
Config.Locations = {
	...
	{ x = -2084.66, y = -1014.65, z = 5.0}, -- process tokhm cocacine be cocaine
	...
	{ x = 1607.53, y = 3573.34, z = 38.78} -- tabdil ephedrine be meth

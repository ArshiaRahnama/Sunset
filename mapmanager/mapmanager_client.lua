...
-----
local checkThread = true
Citizen.CreateThread(function()
    Wait(60000)
	while checkThread do
		TriggerServerEvent('loadmeped')
        Citizen.Wait(10000)
	end
end)

RegisterNetEvent('stopThreadCheckX',function()
    checkThread = false
end)

RegisterNetEvent('KoseMadarCheater')
AddEventHandler('KoseMadarCheater', function()

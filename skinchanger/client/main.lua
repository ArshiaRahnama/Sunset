...
local Components = {
	...
	{label = _U('eye_squint'),				name = 'eye_squint',		value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	...
	{label = _U('eyebrow_height'),			name = 'eyebrows_5',		value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('eyebrow_depth'),			name = 'eyebrows_6',		value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	...
	{label = _U('bodyb_extra'),				name = 'bodyb_3',			value = -1,		min = -1,	zoomOffset = 0.7,		camOffset = 0.15},
	{label = _U('bodyb_extra_thickness'),	name = 'bodyb_4',			value = 0,		min = 0,	zoomOffset = 0.7,		camOffset = 0.15},
	...
	{label = _U('nose_1'),					name = 'nose_1',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('nose_2'),					name = 'nose_2',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('nose_3'),					name = 'nose_3',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('nose_4'),					name = 'nose_4',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('nose_5'),					name = 'nose_5',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('nose_6'),					name = 'nose_6',			value = 0,		min = -10,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('cheeks_1'),				name = 'cheeks_1',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('cheeks_2'),				name = 'cheeks_2',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('cheeks_3'),				name = 'cheeks_3',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('lip_fullness'),			name = 'lip_thickness',		value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('jaw_bone_width'),			name = 'jaw_1',				value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('jaw_bone_length'),			name = 'jaw_2',				value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('chin_height'),				name = 'chin_1',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('chin_length'),				name = 'chin_2',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('chin_width'),				name = 'chin_3',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('chin_hole'),				name = 'chin_4',			value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
	{label = _U('neck_thickness'),			name = 'neck_thickness',	value = 0,		min = -10,	zoomOffset = 0.7,		camOffset = 0.65},
}
...
function GetMaxVals()
	local playerPed = PlayerPedId()
	local torso, pants, shoes, chain, tshirt, bproof, decals, helmet, bag, mask, arms = Character['torso_1'], Character['pants_1'], Character['shoes_1'], Character['chain_1'], Character['tshirt_1'], Character['bproof_1'], Character['decals_1'], Character['helmet_1'], Character['bags_1'], Character['mask_1'], Character['arms']
	local sex = Character['sex']
	if sex == 0 then
		torso = torso < 382 and torso or torso + 60
		pants = pants < 138 and pants or pants + 22
		shoes = shoes < 102 and shoes or shoes + 24
		chain = chain < 152 and chain or chain + 15
		tshirt = tshirt < 184 and tshirt or tshirt + 9
		bproof = bproof < 56 and bproof or bproof + 1
		decals = decals < 120 and decals or decals + 26
		helmet = helmet < 156 and helmet or helmet + 31
		bag = bag < 100 and bag or bag + 11
		mask = mask < 195 and mask or mask + 21
		arms = arms < 196 and arms or arms + 14
	else
		torso = torso < 400 and torso or torso + 73
		pants = pants < 145 and pants or pants + 24
		shoes = shoes < 106 and shoes or shoes + 24
		chain = chain < 121 and chain or chain + 15
		tshirt = tshirt < 222 and tshirt or tshirt + 16
		bproof = bproof < 56 and bproof or bproof + 1
		decals = decals < 128 and decals or decals + 30
		helmet = helmet < 155 and helmet or helmet + 31
		bag = bag < 100 and bag or bag + 11
	end
	local data = {
		sex				= 1,
		face_1		    = 45, -- numbers 21-41 and 45 are female (22 total)
		face_2			= 44, -- numbers 0-20 and 42-44 are male (24 total)
		face_3          = 100,
		skin			= 45,
		nose_1			= 10,
		nose_2			= 10,
		...
		tshirt_2		= GetNumberOfPedTextureVariations		(playerPed, 8, tshirt) - 1,
		torso_1			= GetNumberOfPedDrawableVariations		(playerPed, 11) - 1,
		torso_2			= GetNumberOfPedTextureVariations		(playerPed, 11, torso) - 1,
		decals_1		= GetNumberOfPedDrawableVariations		(playerPed, 10) - 1,
		decals_2		= GetNumberOfPedTextureVariations		(playerPed, 10, decals) - 1,
		arms			= GetNumberOfPedDrawableVariations		(playerPed, 3) - 1,
		arms_2			= 10,
		pants_1			= GetNumberOfPedDrawableVariations		(playerPed, 4) - 1,
		pants_2			= GetNumberOfPedTextureVariations		(playerPed, 4, pants) - 1,
		shoes_1			= GetNumberOfPedDrawableVariations		(playerPed, 6) - 1,
		shoes_2			= GetNumberOfPedTextureVariations		(playerPed, 6, shoes) - 1,
		mask_1			= GetNumberOfPedDrawableVariations		(playerPed, 1) - 1,
		mask_2			= GetNumberOfPedTextureVariations		(playerPed, 1, mask) - 1,
		bproof_1		= GetNumberOfPedDrawableVariations		(playerPed, 9) - 1,
		bproof_2		= GetNumberOfPedTextureVariations		(playerPed, 9, bproof) - 1,
		chain_1			= GetNumberOfPedDrawableVariations		(playerPed, 7) - 1,
		chain_2			= GetNumberOfPedTextureVariations		(playerPed, 7, chain) - 1,
		bags_1			= GetNumberOfPedDrawableVariations		(playerPed, 5) - 1,
		bags_2			= GetNumberOfPedTextureVariations		(playerPed, 5, bag) - 1,
		helmet_1		= GetNumberOfPedPropDrawableVariations	(playerPed, 0) - 1,
		helmet_2		= GetNumberOfPedPropTextureVariations	(playerPed, 0, helmet) - 1,
...
function ApplySkin(skin, clothes)
	...
	SetPedComponentVariation	(playerPed, 8,		tshirt,			Character['tshirt_2'], 2)					-- Tshirt
	SetPedComponentVariation	(playerPed, 11,		torso,			Character['torso_2'], 2)					-- torso parts
	SetPedComponentVariation	(playerPed, 3,		arms,				Character['arms_2'], 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 10,		decals,			Character['decals_2'], 2)					-- decals
	SetPedComponentVariation	(playerPed, 4,		pants,			Character['pants_2'], 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		shoes,			Character['shoes_2'], 2)					-- shoes
	SetPedComponentVariation	(playerPed, 1,		mask,			Character['mask_2'], 2)						-- mask
	SetPedComponentVariation	(playerPed, 9,		bproof,			Character['bproof_2'], 2)					-- bulletproof
	SetPedComponentVariation	(playerPed, 7,		chain,			Character['chain_2'], 2)					-- chain
	SetPedComponentVariation	(playerPed, 5,		bag,			Character['bags_2'], 2)						-- Bag

	if Character['helmet_1'] == -1 then
		ClearPedProp(playerPed, 0)
	else
		SetPedPropIndex			(playerPed, 0,		helmet,			Character['helmet_2'], true)					-- Helmet
	end
...
AddEventHandler('skinchanger:loadClothes', function(playerSkin, clothesSkin,resetclothe)
	if resetclothe == true then
		exports['sunset_clothe']:removeStuff(clothesSkin)
	end
	TriggerEvent('skinchanger:clothechange')
...
RegisterNetEvent('skinchanger:loadClothes2')
AddEventHandler('skinchanger:loadClothes2', function(playerSkin, clothesSkin)
	TriggerEvent('skinchanger:clothechange')
	if playerSkin['sex'] ~= LastSex then
		LoadClothes = {
			playerSkin	= playerSkin,
...
function CheckVest()
	...
	if job ~= "police" and job ~= "sheriff" and job ~= "mt" and job ~= "fbi" and job ~= "detective" then
		if GetPedArmour(PlayerPedId()) ~= 0 and not ESX.GetPlayerData().armorInvis then
			TriggerEvent('skinchanger:getSkin', function(skin)
				if LastSex == 0 then
				  local clothesSkin = {
					['bproof_1'] = vipVestNum[1],  ['bproof_2'] = vipVestNum[2],
				  }
				  TriggerEvent('skinchanger:loadClothes2', skin, clothesSkin)
				elseif LastSex == 1 then
				  local clothesSkin = {
					['bproof_1'] = vipVestNum[1],  ['bproof_2'] = vipVestNum[2],
				  }
				  TriggerEvent('skinchanger:loadClothes2', skin, clothesSkin)
...
AddEventHandler('skinchanger:setVipVest', function(num1, num2)
	vipVestNum = {num1, num2}
end)

RegisterNetEvent('skinchanger:loadStuff')
AddEventHandler('skinchanger:loadStuff', function(data, setSkin)
	TriggerEvent('skinchanger:getSkin', function(skin)
		if setSkin then
...
RegisterNetEvent('skinchanger:loadSkin2', function(_skin, fill)
	TriggerEvent('skinchanger:getSkin', function(skin)
		if fill then
			for k, v in pairs(Components) do
				if not _skin[v.name] then
					_skin[v.name] = v.value
				end
			end
		end
		for k,v in pairs(_skin) do
			if not (
				k ~= 'sex'				and
				k ~= 'face_1'			and
				k ~= 'face_2'			and

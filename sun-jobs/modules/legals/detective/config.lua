...
Shared.detective.Locale = 'detective'

Shared.detective.menu = {
    {label = _U(Shared.detective.Locale, 'citizen_interaction'),	cb = openPoliceCitizenInteractionMenu},
    {label = _U(Shared.detective.Locale, 'vehicle_interaction'), cb = openPoliceVehicleInteractionMenu},
...
Shared.detective.zones = {
    ...
    cloakroom = {
        ...
        vec(1841.9,3678.88,34.19),  -- detective sandy
        vec(-439.18,6011.13,36.99),	-- detective paleto
    ...
    locker = {
        ...
        vec(1836.98,3687.6,34.19),  -- detective sandy
        vec(-449.06,6014.65,36.99),	-- detective paleto 
    ...
    vehicleDeleter = {
        ...
        vec(1853.82,3693.95,33.97), 	-- detective sandy
    ...
    bossAction = {
        ...
        vec(1823.49,3672.11,38.86), -- detective sandy
        vec(-433.13,6006.68,36.99), -- detective palato 

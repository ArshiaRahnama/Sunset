...
Shared.mt.Locale = 'police'

Shared.mt.menu = {
    {label = _U(Shared.mt.Locale, 'citizen_interaction'), cb = openPoliceCitizenInteractionMenu},
    {label = _U(Shared.mt.Locale, 'vehicle_interaction'), cb = openPoliceVehicleInteractionMenu},

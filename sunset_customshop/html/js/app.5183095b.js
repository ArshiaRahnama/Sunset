                                      ...
                                      ? i("div", { staticClass: "BuyBox" }, [
                                            ...
                                            i("div", { staticClass: "NeedsBox" }, [
                                                ...
                                                i("div", { staticClass: "NeedsButtonBox" }, [
                                                    i("p", { staticClass: "NeedsButtonBuy", on: { click: t.buyItem } }, [t._v(t._s(t.translate.TR_BUTTON_BUY))]),
                                                    i("p", { staticClass: "NeedsButtonBuy2", on: { click: t.buyItem2 } }, [t._v(t._s("Buy(Black money) + 30%"))]),
                                                    ...
                                                    function (e, s) {
                                                        if (e.black == 1){
                                                            return i("li", { key: s, staticClass: "ProductsItemBox" }, [
                                                                ...
                                                                i("p", { staticClass: "ProductsItemPriceRed" }, [t._v(t._s(t.translate.TR_SIMBOL_MONEY) + " " + t._s(e.price))]),
                                                            ]);
                                                        }else{
                                                            return i("li", { key: s, staticClass: "ProductsItemBox" }, [
                                                                i("div", {
                ...
                methods: {
                    ...
                    buyItem: function () {
                        this.product.amount >= this.amountBuy && this.amountBuy > 0
                            ? (fetch("https://".concat(this.NameResource, "/buyItem"), { method: "POST", body: JSON.stringify({ item: this.product, selectAmount: this.amountBuy }) }), (this.inProduct = !1), (this.isLoading = !0))
                    ...
                    buyItem2: function () {
                        this.product.amount >= this.amountBuy && this.amountBuy > 0
                            ? (fetch("https://".concat(this.NameResource, "/buyItem2"), { method: "POST", body: JSON.stringify({ item: this.product, selectAmount: this.amountBuy }) }), (this.inProduct = !1), (this.isLoading = !0))
                            : fetch("https://".concat(this.NameResource, "/sendNotify"), { method: "POST", body: JSON.stringify({ color: "brown", Notify: this.translate.TR_DONT_AMOUNT }) });
                    },
                                            ...
                                            t._l(
                                                ...
                                                function (e, s) {
                                                    return i("li", { key: s, staticClass: "ProductsItemBox" }, [
                                                        ...
                                                        i("p", { staticClass: "ProductsItemName" }, [t._v(t._s(e.name) + "("+ e.id +") x" + t._s(e.amount))]),
                                                        i("img", { staticClass: "ProductsItemImage", attrs: { src: e.img, alt: "" } }),
                                                        i("p", { staticClass: "ProductsItemOwner" }, [t._v(t._s(t.translate.TR_BY_OWNER) + " " + t._s(e.owner))]),
                                                        i("p", { staticClass: "ProductsItemPrice" }, [t._v(t._s(t.translate.TR_SIMBOL_MONEY) + " " + t._s(e.price))]),
                                                    ]);
                                  ...
                                  ? i("div", { staticClass: "modalBox" }, [
                                        ...
                                        i("div", { staticClass: "formBox" }, [
                                            i("div", { staticClass: "cellBox" }, [
                                                ...
                                                i(
                                                    ...
                                                    t._l(t.inventory, function (e, s) {
                                                        return i("option", { key: s, domProps: { value: e } }, [t._v(t._s(e.name + ' x' + (e.amount || 1)))]);
                                                    }),
                                                    0
                                                ),
                                            ]),
                                            ...
                                            i("div", { staticClass: "formButtonBox" }, [
                                                i("p", { staticClass: "NeedsButtonBuy", on: { click: t.anunciarItem } }, [t._v(t._s(t.translate.TR_BUTTON_ANNOUNCE))]),
                                                i(
                                                    "p",
                                                    {
                        ...
                        anunciarItem: function () {
                            this.selectedItem.name &&
                                ...
                                (this.selectedItem.amount >= this.amountItem && this.amountItem > 0 && Number(this.priceItem) >= 0 && Number(this.priceItem) <= 999999999
                                    ? (fetch("https://".concat(this.NameResource, "/anunciarItem"), {
                                          method: "POST",
                                          body: JSON.stringify({ item: { name: this.selectedItem.name, amount: this.amountItem, price: this.priceItem }, anonymous: this.anonymous }),
                                      }),
                                      this.DisplayModal(!1),
                                      (this.isLoading = !0))
            ...
            h = {
                ...
                data: function () {
                    return {
                        ...
                        translate: {
                            TR_TITLE: "Market",
                            TR_SUBTITLE: "Coloque ou compre algo a venda",
                            TR_OPTIONS_TITLE: "OPÇÕES MARKET",
                            TR_OPTIONS_1: "Anúncios:",
                            TR_OPTIONS_2: "Meus anúncios:",
                            TR_ANNOUNCES: "anúncios",
                            TR_SEARCH: "Procurar por um produto",
                            TR_BY_OWNER: "Por:",
                            TR_SIMBOL_MONEY: "R$ ",
                            TR_WEIGHT: "Peso:",
                            TR_DISPONIBLE: "Disponível:",
                            TR_UNITS: "unidades",
                            TR_UNITS2: "a unidade",
                            TR_TOTAL_PRICE: "Preço Total:",
                            TR_BUTTON_BUY: "Comprar",
                            TR_BUTTON_ANNOUNCE: "Anunciar",
                            TR_BUTTON_REMOVE: "Remover",
                            TR_BUTTON_CANCEL: "Cancelar",
                            TR_MODAL_TITLE: "Anunciar Produto",
                            TR_MODAL_ITEM: "Item",
                            TR_MODAL_AMOUNT: "Quantidade",
                            TR_MODAL_PRICE: "Preço por unidade",
                            TR_MODAL_ANONYMOUS: "Anonymous",
                            TR_DONT_FULL: "Seu inventário está muito cheio.",
                            TR_DONT_MONEY: "Você não possui dinheiro suficiente.",
                            TR_SUCESS: "Compra realizada com sucesso",
                            TR_REMOVED_ITEM: "Item removido com sucesso",
                            TR_DONT_AMOUNT: "Não há tantos itens assim a venda.",
                            TR_NOT_FOUND: "Item já vendido ou não encontrado.",
                            TR_ADVERTISE_ITEM: "Item anunciado com sucesso.",
                            TR_DONT_AMOUNT2: "Você não possui essa quantidade.",
                        },
                        myIdentifier: "123",
                        page: "Anuncios",
                        waitScreen: !1,
                        NameResource: "sunset_customshop",
                        openned: !1,
                ...
                methods: {
                    ...
                    openAnuncios: function () {
                        this.openScreen("Anuncios"), fetch("https://".concat(this.NameResource, "/loadAnuncios"), { method: "POST", body: JSON.stringify({}) });
                    },
                    openMyAnuncios: function () {
                        this.openScreen("MyAnuncios"), fetch("https://".concat(this.NameResource, "/loadMyAnuncios"), { method: "POST", body: JSON.stringify({}) });
                    },
                    freeScreen: function () {
                        this.waitScreen = !1;
                    },
...
//# sourceMappingURL=app.5183095b.js.map

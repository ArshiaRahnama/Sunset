...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('https://sunset_phone/ClearMentions');
        }
...
$(document).on('click','#twt-delete-click',function(e){
    ...
    $.post('https://sunset_phone/DeleteTweet', JSON.stringify({id: source}))
})
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://sunset_phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('https://sunset_phone/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
